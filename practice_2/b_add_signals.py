...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonPlainTextEdit.clicked.connect(self.onPushButtonTextPlainEditClicked)  # TODO подключить слот для вывода текста из plaineTextEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.comboBox.textActivated.connect(self.onComboBoxChanged)  # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
        ...
        self.dateTimeEdit.dateChanged.connect(self.onDateTimeChanged)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def onPushButtonTextPlainEditClicked(self):
